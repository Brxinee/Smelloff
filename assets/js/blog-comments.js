...
(function () {
  ...
  // --- Scoped styles (unified technical precision: Fraunces display,
  //     Inter Tight functional text, JetBrains Mono metadata, canonical tokens)
  var style = document.createElement('style');
  style.textContent = [
    '.bc-wrap{max-width:680px;margin:0 auto;padding:0 32px 80px;font-family:"Inter Tight",sans-serif}',
    ...
    '.bc-title{font-family:"Fraunces",serif;font-weight:900;font-size:24px;letter-spacing:-.01em;text-transform:none;color:#F5F5F5;margin:0;line-height:1.2}',
    '.bc-count{font-family:"JetBrains Mono",monospace;font-weight:700;font-size:14px;color:#B8FF57;letter-spacing:.05em}',
    // Trigger button — technical CTA
    '.bc-cta{display:inline-flex;align-items:center;gap:8px;background:#B8FF57;color:#080808;font-family:"Inter Tight",sans-serif;font-weight:700;font-size:13.5px;letter-spacing:.02em;text-transform:none;padding:10px 18px;border:none;border-radius:8px;box-shadow:none;cursor:pointer;transition:background-color .15s ease,transform .15s ease}',
    '.bc-cta:hover{background:#d1ff8a;transform:translateY(-1px)}',
    '.bc-cta:active{transform:scale(.98)}',
    // List (compact cards)
    '.bc-list{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:12px}',
    '.bc-card{background:#0F0F0F;border:1px solid #222222;border-radius:12px;box-shadow:none;padding:14px 18px}',
    '.bc-card-head{display:flex;align-items:baseline;justify-content:space-between;gap:10px;flex-wrap:wrap;margin:0 0 4px}',
    '.bc-name{font-family:"Inter Tight",sans-serif;font-weight:700;font-size:14.5px;letter-spacing:0;text-transform:none;color:#B8FF57}',
    '.bc-time{font-family:"JetBrains Mono",monospace;font-size:11.5px;color:#8C8C8C;letter-spacing:.02em;white-space:nowrap}',
    '.bc-body{font-family:"Inter Tight",sans-serif;font-size:14.5px;line-height:1.6;color:#F5F5F5;white-space:pre-wrap;word-wrap:break-word;overflow-wrap:anywhere}',
    '.bc-state{font-family:"Inter Tight",sans-serif;font-size:14.5px;color:#8C8C8C;padding:6px 0}',
    // "View more" drawer
    '.bc-drawer{max-height:0;overflow:hidden;transition:max-height .35s ease}',
    '.bc-drawer .bc-list{margin-top:12px}',
    '.bc-more{display:inline-flex;align-items:center;gap:8px;margin-top:16px;background:transparent;color:#F5F5F5;font-family:"Inter Tight",sans-serif;font-weight:600;font-size:13.5px;letter-spacing:.02em;text-transform:none;padding:9px 16px;border:1px solid #333333;border-radius:8px;box-shadow:none;cursor:pointer;transition:background-color .15s ease,border-color .15s ease}',
    '.bc-more:hover{background:#141414;border-color:#444444}',
    ...
    '.bc-modal-card{position:relative;width:100%;max-width:520px;margin:auto;background:#111111;border:1px solid rgba(255,255,255,.14);border-radius:16px;box-shadow:0 20px 48px rgba(0,0,0,.7);padding:26px 24px}',
    '.bc-modal-title{font-family:"Fraunces",serif;font-weight:900;font-size:20px;letter-spacing:-.01em;text-transform:none;color:#F5F5F5;margin:0 0 4px;padding-right:40px}',
    '.bc-modal-sub{font-family:"Inter Tight",sans-serif;font-size:13px;color:#8C8C8C;margin:0 0 18px}',
    '.bc-x{position:absolute;top:14px;right:14px;width:34px;height:34px;display:flex;align-items:center;justify-content:center;background:#080808;color:#F5F5F5;font-family:"Inter Tight",sans-serif;font-weight:500;font-size:18px;line-height:1;border:1px solid #262626;border-radius:6px;cursor:pointer;transition:background .12s ease,color .12s ease}',
    '.bc-x:hover{background:#B8FF57;color:#080808;border-color:#B8FF57}',
    '.bc-field{margin:0 0 14px}',
    '.bc-label{display:block;font-family:"JetBrains Mono",monospace;font-weight:500;font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:#F5F5F5;margin:0 0 6px}',
    '.bc-input,.bc-textarea{width:100%;background:#080808;color:#F5F5F5;border:1px solid #262626;border-radius:8px;padding:11px 13px;font-family:"Inter Tight",sans-serif;font-size:15px;line-height:1.5;box-shadow:none;-webkit-appearance:none;appearance:none;transition:border-color .12s ease}',
    '.bc-input:focus,.bc-textarea:focus{outline:none;border-color:#B8FF57;box-shadow:none}',
    ...
    '.bc-counter{font-family:"JetBrains Mono",monospace;font-weight:400;font-size:11px;letter-spacing:.05em;color:#8C8C8C}',
    '.bc-submit{display:inline-block;background:#B8FF57;color:#080808;font-family:"Inter Tight",sans-serif;font-weight:700;font-size:14px;letter-spacing:.02em;text-transform:none;padding:12px 22px;border:none;border-radius:8px;box-shadow:none;cursor:pointer;transition:background-color .15s ease,transform .15s ease}',
    '.bc-submit:hover:not(:disabled){background:#d1ff8a;transform:translateY(-1px)}',
    '.bc-submit:active:not(:disabled){transform:scale(.98)}',
    '.bc-submit:disabled{opacity:.55;cursor:not-allowed}',
    '.bc-msg{font-family:"Inter Tight",sans-serif;font-size:13.5px;font-weight:500;margin:14px 0 0;padding:10px 13px;border:none;border-radius:8px}',
    '.bc-msg.err{color:#080808;background:#ff6b6b}',
    '.bc-msg.ok{color:#080808;background:#B8FF57}',
