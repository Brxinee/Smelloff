...
(function () {
  ...
  style.textContent = [
    ...
    '.bc-cta{display:inline-flex;align-items:center;gap:8px;background:#B8FF57;color:#080808;font-family:"Barlow Condensed",sans-serif;font-weight:900;font-size:15px;letter-spacing:.1em;text-transform:uppercase;padding:11px 20px;border:none;border-radius:8px;box-shadow:none;cursor:pointer;transition:background-color .15s ease,transform .15s ease}',
    ...
    '.bc-input,.bc-textarea{width:100%;background:#080808;color:#F5F5F5;border:1px solid #262626;border-radius:8px;padding:11px 13px;font-family:"DM Sans",sans-serif;font-size:16px;line-height:1.5;box-shadow:none;-webkit-appearance:none;appearance:none;transition:border-color .12s ease}',
    ...
    '.bc-msg{font-family:"DM Sans",sans-serif;font-size:14px;font-weight:600;margin:14px 0 0;padding:10px 13px;border:none;border-radius:8px}',
