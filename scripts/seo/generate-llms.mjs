...
const PAGES = [
  ...
  ['Why Collar and Armpits Still Smell After Washing', 'https://smelloff.in/blog/why-shirt-zones-smell-after-washing', 'Two contact zones. Two soils. One wash that treated the shirt as a single object.'],
  ['Wash It, Refresh It, or Wear It', 'https://smelloff.in/blog/wash-refresh-or-wear', 'A shirt decision tree for the morning, the 4-minute meeting panic, and the 12-hour workday.'],
  ['Does Vinegar, Baking Soda or Fabric Softener Remove Odor?', 'https://smelloff.in/blog/vinegar-baking-soda-fabric-softener', 'Vinegar is an acid rinse. Baking soda is a mild alkali. Softener is a film. None of them is a sweat-odor killer.'],
  ['How to Dry Clothes Indoors in an Indian Home Without Smell', 'https://smelloff.in/blog/dry-air-clothes-indian-home', 'A ceiling rod in a closed bathroom is not a drying system. Space, air, a balcony hour, and seams that are actually dry.'],
  ['Why the Washing Machine Makes Clothes Smell', 'https://smelloff.in/blog/why-washing-machine-makes-clothes-smell', 'A biofilm in the gasket. A wet load left long enough to go sour. Front-loaders in Indian bathrooms do both.'],
  ['How to Remove Incense, Agarbatti and Dhoop Smell from Clothes', 'https://smelloff.in/blog/remove-incense-agarbatti-dhoop-smell', 'Agarbatti and dhoop leave particles and resin volatiles in cloth. That is not sweat and it is not cooking oil.'],
  ['Why Clothes Smell Worse When They Get Wet — and in Humidity', 'https://smelloff.in/blog/why-water-makes-clothing-odor-louder', 'A dried shirt that smells again in the rain, and the same shirt that is louder at 80% RH, are one physics story.'],
  ['Why Clothes Smell Stale in an AC Room', 'https://smelloff.in/blog/why-clothes-smell-stale-in-ac-room', 'An AC room recirculates the same cabin. Hung clothes pick up that room note. An under-washed shirt adds its own.'],
  ['Why Traffic Fumes Cling to Clothes', 'https://smelloff.in/blog/why-traffic-fumes-cling-to-clothes', 'The commute coats the outer face of the shirt with particles and fuel volatiles. It is not sweat and it is not kitchen tadka.'],
  ['Why Deodorant and Perfume Fail on a Sweaty Shirt', 'https://smelloff.in/blog/deodorant-perfume-on-fabric', 'Deodorant is for skin. Perfume is for a clean dry shirt. Both on a worn weave can stain, clash, and get louder as the alcohol flashes off.'],
  ['Why Sweat Smells Stronger on Some Shirts', 'https://smelloff.in/blog/why-sweat-smells-stronger-on-some-shirts', 'Loudness is a stack: fibre, finish, fit, residue age, and whether the last wash actually stripped it. Polyester is one layer, not the whole story.'],
  ['How an Odor Neutralizer Works on Fabric', 'https://smelloff.in/blog/how-odor-neutralizer-works-on-fabric', 'A fabric odor mist is a stack: a cage that traps the molecule, zinc that quiets it, citrate that slows the next batch. Cover is not a mechanism.'],
