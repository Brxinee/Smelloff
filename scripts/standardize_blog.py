...
FOOTER = '''<footer class="blog-footer" aria-labelledby="footer-brand">
  <div class="footer-grid">
    <div class="footer-brand">
      ...
      <a class="bf-ig" href="https://www.linkedin.com/company/smelloff" target="_blank" rel="noopener"><img src="/assets/icon-linkedin-white.png" alt="" width="15" height="15" loading="lazy">LinkedIn ↗</a>
      <a class="bf-ig" href="https://www.facebook.com/share/1BU1dCAttY/" target="_blank" rel="noopener"><img src="/assets/icon-facebook-white.png" alt="" width="15" height="15" loading="lazy">Facebook ↗</a>
      <a class="bf-ig" href="https://wa.me/919392974031" target="_blank" rel="noopener"><img src="/assets/icon-whatsapp-white.png" alt="" width="15" height="15" loading="lazy">WhatsApp ↗</a>
    </div>
