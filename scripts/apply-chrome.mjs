...
function ensureAssets(html) {
  ...
  const criticalChrome = `<style id="sf-critical-chrome">.sf-wrap{width:100%;max-width:var(--maxw);margin-inline:auto;padding-inline:var(--gutter)}.sf-hdr{position:sticky;top:0;z-index:70;background:var(--ink);border-bottom:1px solid var(--rule)}.sf-hdr__row{display:flex;align-items:center;justify-content:space-between;gap:12px;min-height:64px}.sf-hdr__logo{display:flex;align-items:center;min-height:44px}.sf-hdr__logo img{height:24px;width:auto;display:block}.sf-hdr__right{display:flex;align-items:center;gap:10px}.sf-cart{display:inline-flex;align-items:center;gap:5px;height:44px;padding:0 4px;background:transparent;color:var(--text);text-decoration:none;border:0;cursor:pointer;line-height:1}.sf-cart svg{width:25px;height:25px;display:block}.sf-cart__count{background:var(--acid);color:var(--on-acid);min-width:18px;height:18px;padding:0 5px;border-radius:var(--sq-pill);display:inline-flex;align-items:center;justify-content:center;font:700 11px/1 var(--body)}.sf-cart__count[hidden],.sf-cart__count[data-empty="1"]{display:none}.sf-nav{display:none;align-items:center;gap:6px;list-style:none;margin:0;padding:0}.sf-nav a{display:inline-block;padding:12px 14px;border-radius:var(--sq-sm);font:13px var(--mono);color:var(--text);text-decoration:none;letter-spacing:.12em;text-transform:uppercase}.sf-hdr__cta{display:inline-flex;align-items:center;justify-content:center;flex-direction:column;gap:2px;line-height:1.15;background:var(--acid);color:var(--on-acid);text-decoration:none;border:0;border-radius:var(--sq-sm);font:13px/1.15 var(--mono);letter-spacing:.08em;text-transform:uppercase;padding:8px 14px;min-height:44px}.sf-hdr__cta-sub{font-size:9px;letter-spacing:.06em;opacity:.85;font-weight:400;white-space:nowrap}.sf-burger{display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;width:44px;height:44px;background:none;padding:0;border:0;color:var(--text);cursor:pointer}.sf-burger span{display:block;width:26px;height:3px;border-radius:100px;background:currentColor}.sf-hdr__menu{display:block;max-height:0;opacity:0;visibility:hidden;overflow:hidden;pointer-events:none;padding:0;list-style:none;margin:0}.sf-skip{position:absolute;left:-9999px;top:0;z-index:200;background:var(--acid);color:var(--on-acid);padding:12px 20px;font-weight:700;text-decoration:none}.sf-skip:focus{left:0}@media(min-width:900px){.sf-nav{display:flex}.sf-burger{display:none}.sf-hdr__menu{display:none!important}.sf-hdr__logo img{height:28px}}</style>`;
