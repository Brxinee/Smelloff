  ...
  <div class="sf-wrap">
    <div class="sf-hdr__row">
      <a href="/" class="sf-hdr__logo" aria-label="Smelloff home">
        <img src="/assets/optimized/logo-smelloff-white-160.webp" alt="SMELLOFF" width="1200" height="261" decoding="async">
      </a>
      <div class="sf-hdr__right">
        ...
        <a href="/odorstrike#buy" class="sf-hdr__cta">Buy ₹${PRODUCT_CONFIG.product.price}<span class="sf-hdr__cta-sub">free shipping</span></a>
  ...
  <div class="sf-wrap">
    <div class="sf-ftr__grid">
      <div class="sf-ftr__brand">
        <img src="/assets/optimized/logo-smelloff-white-160.webp" alt="SMELLOFF" width="1200" height="261" loading="lazy">
        <p>Pocket-sized fabric odor neutralizer. Made for clothes.</p>
      </div>
      <div>
        <h3>Shop</h3>
        <ul>
...
function ensureAssets(html) {
  ...
  const criticalChrome = `<style id="sf-critical-chrome">.sf-wrap{width:100%;max-width:1160px;margin-inline:auto;padding-inline:20px}.sf-hdr{position:sticky;top:0;z-index:70;background:#080808;border-bottom:1px solid rgba(244,241,234,.14)}.sf-hdr__row{display:flex;align-items:center;justify-content:space-between;gap:12px;min-height:64px}.sf-hdr__logo{display:flex;align-items:center;min-height:44px}.sf-hdr__logo img{height:24px;width:auto;display:block}.sf-hdr__right{display:flex;align-items:center;gap:10px}.sf-cart{display:inline-flex;align-items:center;gap:5px;height:44px;padding:0 4px;background:transparent;color:#F4F1EA;text-decoration:none;border:0;cursor:pointer;line-height:1}.sf-cart svg{width:25px;height:25px;display:block}.sf-cart__count{background:#B8FF57;color:#080808;min-width:18px;height:18px;padding:0 5px;border-radius:100px;display:inline-flex;align-items:center;justify-content:center;font:700 11px/1 system-ui,sans-serif}.sf-cart__count[hidden],.sf-cart__count[data-empty="1"]{display:none}.sf-nav{display:none;align-items:center;gap:6px;list-style:none;margin:0;padding:0}.sf-nav a{display:inline-block;padding:12px 14px;border-radius:8px;font:13px/1 ui-monospace,monospace;color:#F4F1EA;text-decoration:none;letter-spacing:.12em;text-transform:uppercase}.sf-hdr__cta{display:inline-flex;align-items:center;justify-content:center;flex-direction:column;gap:2px;line-height:1.15;background:#B8FF57;color:#080808;text-decoration:none;border:0;border-radius:8px;font:13px/1.15 ui-monospace,monospace;letter-spacing:.08em;text-transform:uppercase;padding:8px 14px;min-height:44px}.sf-hdr__cta-sub{font-size:9px;letter-spacing:.06em;opacity:.85;font-weight:400;white-space:nowrap}.sf-burger{display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;width:44px;height:44px;background:none;padding:0;border:0;color:#F4F1EA;cursor:pointer}.sf-burger span{display:block;width:26px;height:3px;border-radius:100px;background:currentColor}.sf-hdr__menu{display:block;max-height:0;opacity:0;visibility:hidden;overflow:hidden;pointer-events:none;padding:0;list-style:none;margin:0}.sf-skip{position:absolute;left:-9999px;top:0;z-index:200;background:#B8FF57;color:#080808;padding:12px 20px;font-weight:700;text-decoration:none}.sf-skip:focus{left:0}@media(min-width:900px){.sf-nav{display:flex}.sf-burger{display:none}.sf-hdr__menu{display:none!important}.sf-hdr__logo img{height:28px}}</style>`;
