...
${navLis(NAV_ITEMS)}
        ...
        <a href="/odorstrike#buy" class="sf-hdr__cta so-btn so-btn--p1" data-smelloff-buy="header">Buy ₹${PRICE}</a>
  ...
  <div class="sf-wrap">
    <div class="sf-ftr__grid">
      ...
      <div>
        <h3>Shop</h3>
        <ul>
          <li><a href="/odorstrike">${T.productName}</a></li>
...
<aside class="so-buy" data-so-buy aria-label="Buy ${T.productName}">
  <div class="sf-wrap">
    <div class="so-buy__panel">
      ...
      <a class="so-btn so-btn--p1 so-buy__cta" href="/odorstrike?buy=1" data-so-cta data-smelloff-buy="buymodule">Buy ${T.productName} — ₹${T.pricePrepaid}</a>
