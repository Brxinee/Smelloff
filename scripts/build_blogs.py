...
<footer class="blog-footer">
  ...
  <div class="footer-links">
    ...
    <a href="https://instagram.com/smelloffindia" target="_blank" rel="noopener"><img src="/assets/icon-instagram-white.png" alt="" style="width:14px;height:14px;vertical-align:-2px;margin-right:6px;opacity:.8" loading="lazy">Instagram</a>
    <a href="https://x.com/smelloffindia" target="_blank" rel="noopener"><img src="/assets/icon-x.png" alt="" style="width:14px;height:14px;vertical-align:-2px;margin-right:6px;opacity:.8" loading="lazy">X (Twitter)</a>
    <a href="https://t.me/smelloffindia" target="_blank" rel="noopener"><img src="/assets/icon-telegram-white.png" alt="" style="width:14px;height:14px;vertical-align:-2px;margin-right:6px;opacity:.8" loading="lazy">Telegram</a>
    <a href="https://www.linkedin.com/company/smelloff" target="_blank" rel="noopener"><img src="/assets/icon-linkedin-white.png" alt="" style="width:14px;height:14px;vertical-align:-2px;margin-right:6px;opacity:.8" loading="lazy">LinkedIn</a>
    <a href="https://www.facebook.com/share/1BU1dCAttY/" target="_blank" rel="noopener"><img src="/assets/icon-facebook-white.png" alt="" style="width:14px;height:14px;vertical-align:-2px;margin-right:6px;opacity:.8" loading="lazy">Facebook</a>
    <a href="https://wa.me/919392974031" target="_blank" rel="noopener"><img src="/assets/icon-whatsapp-white.png" alt="" style="width:14px;height:14px;vertical-align:-2px;margin-right:6px;opacity:.8" loading="lazy">WhatsApp</a>
  </div>
